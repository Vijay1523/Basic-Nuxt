            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="person in people" :key="person.email">
                ...
                >
                  ...
                  <button class="text-sm text-red-400 hover:text-red-700">
                    Delete
                  </button>
                </td>
              </tr>
